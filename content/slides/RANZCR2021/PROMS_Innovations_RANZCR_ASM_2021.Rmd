...
---
class: middle
background-image: url("RANZCR_Presentation_ASM_2021_BG.png")
...
background-image: url("Precise_NSCC_logo_353_100.jpg")
...
---
background-image: url('slide14.png')
background-size: cover
class: left, top

---
background-image: url('full_team.png')
background-size: cover
class: left, top
...
---
exclude: true
background-image: url("Precise_NSCC_logo_353_100.jpg"), url("REDCap.png")
background-size: 200px, 400px
background-position: 96% 4%, 90% 92%
# Journey

### 2016
.pull-left[
* **Onsite ePRO** collection (iPad in waiting room) 
* Completion rates (35-59%) were **promising but insufficent**
* Patients' ability to complete ePRO was rarely an issue!
]
.pull-right[
**Main barriers:**
  * Logistical (unavailable devices / volunteers)
  * Suboptimal timing
  * Missing EMR integration
]

### 2017
* **Offsite ePRO**: Unsuccessful search for commercial vendor (survey designer and/or API) 

### 2018

* Re-Discovery of **REDCap** as "ePRO survey engine" 
* Major upgrade of in-house research information system (intranet-based web app)
* Integration of REDCap for ePRO collection
---
background-image: url("Precise_NSCC_logo_353_100.jpg"), url("ir_toolkit_identity_300_who.png")
...
---
background-image: url('ProDB_ePRO.PNG')
background-size: cover
class: left, top

---
background-image: url('REDCap_Pt.PNG')
background-size: contain
background-position: 50% 0%

---
# REDCap as ePRO Survey Engine
<center><img src="REDCap_ePRO_survey_engine_1400.png" alt="drawing" width="900"/></center>

---
background-image: url("Precise_NSCC_logo_353_100.jpg"), url("requite_black.png")
background-size: 200px, 300px
...
---
background-image: url("Precise_NSCC_logo_353_100.jpg"), url("completion_plot2.png")
...
```
---
background-image: url("Precise_NSCC_logo_353_100.jpg"), url("duration_plot2.png")
background-size: 200px, 900px
background-position: 96% 4%, 50% 90%
...
* Slides and **video** here: [URL]

---
background-image: url("Precise_NSCC_logo_353_100.jpg"), url("qr_dashboard.png")
background-size: 200px, 200px
background-position: 96% 4%, 23% 90%
...
.pull-right[
#### Link to ePRO-driven referral process (slides & VIDEO):
[URL] & [QR code]
]
<br>
## Thank you <br> 🙏
